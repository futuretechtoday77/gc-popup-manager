...
const TEMPLATE_OPTIONS: {
  ...
  { key: 'slideup', title: 'Slide-up (Mobile First)', desc: 'Docks to the bottom' },
  { key: 'split',   title: 'Split (Image + Form)',    desc: 'Image left, form right' },
];
          ...
          <section className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              <ColorField
                ...
                onChange={(c) =>
                  set('style', { ...v.style, primaryColor: c })
                }
              />
              <ColorField
                title="Button color"
